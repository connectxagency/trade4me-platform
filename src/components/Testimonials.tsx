...
const Testimonials: React.FC = () => {
  const testimonials = [
    ...
    },
    {
      ...
      content: 'The platform\'s focus on meaningful connections over quantity is refreshing. I\'ve built genuine professional relationships that extend beyond just LinkedIn connections.',
      rating: 5
    }
  ];
