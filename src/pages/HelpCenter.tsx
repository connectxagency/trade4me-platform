          ...
          <div>
            ...
            <div className="text-center mb-12">
              ...
              <p className="text-xl text-gray-300 max-w-2xl mx-auto">
                Find answers to your questions about <img src={trade4meLogo} alt="Trade4me" className="h-4 w-auto inline mx-1" /> and <img src={phemexLogo} alt="Phemex" className="h-5 w-auto inline mx-1" /> trading
              </p>
            </div>

            {/* Search and Filters */}
            <div className="bg-gray-800/40 backdrop-blur-sm rounded-xl p-6 mb-8">
              <div className="relative mb-6">
                ...
                <input
                  ...
                  className="w-full pl-12 pr-4 py-4 bg-gray-700 border border-gray-600 rounded-xl text-white focus:ring-2 focus:ring-blue-500 focus:border-transparent text-lg"
                />
              </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                {filteredItems.map((item) => {
                  ...
                  return (
                    <button
                      ...
                      className="bg-gray-800/40 backdrop-blur-sm rounded-xl p-6 hover:bg-gray-800/60 transition-all duration-300 text-left border border-gray-700/50 hover:border-gray-600/50 transform hover:translate-y-[-2px]"
                    >
                ...
                {filteredItems.length === 0 && (
                  <div className="col-span-full text-center py-20">
                    <HelpCircle className="w-20 h-20 text-gray-600 mx-auto mb-6" />
                    <h4 className="text-2xl font-semibold text-gray-400 mb-4">No Results Found</h4>
          ...
          <div>
            {selectedItem && (
              <>
                <button
                  onClick={backToList}
                  className="flex items-center gap-2 text-blue-400 hover:text-blue-300 transition-colors mb-8 bg-gray-800/40 px-4 py-2 rounded-lg"
                >
                ...
                <div className="bg-gray-800/40 backdrop-blur-sm rounded-xl p-8 border border-gray-700/50">
                  <div className="mb-8">
                    <div className="flex items-center gap-4 mb-6">
                      ...
                      <div>
                        ...
                        <div className="flex items-center gap-3 mt-2">
                          <span className={`px-3 py-1 rounded-lg text-sm font-medium ${getTypeColor(selectedItem.type)}`}>
                    ...
                    {selectedItem.description && (
                      <p className="text-gray-300 text-lg mb-8">{selectedItem.description}</p>
                    )}
                  </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          <div className="text-center">
            ...
            <div className="flex items-center justify-center gap-4">
              <a 
                href="mailto:support@connectx-consulting.com" 
